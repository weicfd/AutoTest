...
public class HttpRequsetUtil {
	...
	public static String sendPost(String url, String param, boolean isproxy) throws IOException {
		...
		try {
			...
			conn.connect();
			// System.out.print(conn.getResponseMessage().length());
	...
	public static void main(String[] args) throws IOException {
		// demo:代理访问
		String url = "http://localhost:8080/GuangDa/login";
		//String para = "{'a':'a1'}";
		String para = "name=admin&password=123456&roler=administer";

		String sr = HttpRequsetUtil.sendPost(url, para, true);
